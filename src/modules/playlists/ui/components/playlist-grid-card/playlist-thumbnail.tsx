    ...
    <div className={cn("relative pt-3", className)}>
      <div className="relative">
        ...
        <div className="relative overflow-hidden w-full rounded-xl aspect-video">
          ...
          />
          {/* Hover */}
          <div className="absolute flex items-center justify-center transition-opacity inset-0 bg-black/70 opacity-0 group-hover:opacity-100">
      ...
      <div className="absolute flex items-center bottom-2 right-2 px-1 py-0.5 rounded bg-black/80 text-white text-xs font-medium gap-x-1">
